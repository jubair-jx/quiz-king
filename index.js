...
let quizContainers = document.querySelector("#quizContainer");
...
const displayQuiz = (data) => {
  if (!data) {
    quizContainers.innerHTML = "";
    return;
  }

  data.forEach((quiz, i) => {
    quizContainers.innerHTML += `<div class="m-3 py-3 px-4 shadow-sm rounded">
...
document.querySelector("#submit").addEventListener("click", () => {
  ...
  // Right side bar/ answer section here this code
  let x = setTimeout(() => {
    showAnswers(answers);
